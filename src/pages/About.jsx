        ...
        <Row>
          <Col md={6}>
            <div className="about-text">
              <h5>Our Story</h5>
              <p>
                Founded in 2023, Foodie emerged from a shared love for food and
                a desire to share that passion with the world. What started as a
                humble blog has evolved into a thriving community of food
                lovers, chefs, and artisans who believe that food is more than
                sustenance; it's an art form, a cultural touchstone, and a
